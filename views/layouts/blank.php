...
<body class="min-h-screen overflow-x-hidden bg-gradient-to-b from-[#0f172a] via-[#111827] to-[#0b1020] text-white">
<?php $this->beginBody() ?>
    ...
    <div class="fixed bottom-6 left-6 z-50">
      <div class="dropdown dropdown-top dropdown-hover">
        <div tabindex="0" role="button" class="btn btn-circle bg-white/20 border-0 backdrop-blur-md hover:bg-white/30 text-white shadow-lg">
        ...
        <ul tabindex="0" class="dropdown-content menu p-2 shadow-lg bg-base-100 rounded-box w-40 text-black">
